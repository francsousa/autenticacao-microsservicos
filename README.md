# Projeto: Autenticação Stateful e Stateles em Microsserviços

Repositório contendo o projeto desenvolvido no curso Autenticação Stateful e Stateles em Microsserviços, ministrado pelo instrutor Victor Hugo Negrisoli.
...
Existem três maneiras de rodar todos os projetos, via script utilitário, manualmente ou via docker-compose.
